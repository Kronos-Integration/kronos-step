...
const baseStep = {
	 ...
	 * @return {object} step A new instance of the step.
	 * @api public
	 */
	...
	toJSONWithOptions(options) {
		...
		console.log(`PROTOTYPE: ${prototype} ${this.prototype} ${this}`);

		ATTRIBUTES.forEach(a => {
			if (this[a] !== this.prototype[a]) {
				json[a] = this[a];
			}
		});
		...
		/*
		if (this.description) {
			console.log(`XXX ${this.prototype}`);
