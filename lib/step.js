...
class Step {
	...
	constructor(manager, scopeReporter, name, stepDefinition) {
		 ...
		 */
		this.start = states.transitionFunction(states.transitions.start);
		 ...
		 */
		this.stop = states.transitionFunction(states.transitions.stop);

		propertyConfigurer(this, manager, name, stepDefinition);

		// Now initialize this step
		this._initialize(scopeReporter, stepDefinition);
	 ...
	 * @api protected
	 */
	_initialize(scopeReporter, stepDefinition) {
		this._beforeInitialize(scopeReporter, stepDefinition);
		this._setupEndpointsFromConfig(scopeReporter, stepDefinition);
		this._setupPredefinedEndpoints(scopeReporter, stepDefinition);
		this._setupEndpoints(scopeReporter, stepDefinition);
		this._afterInitialize(scopeReporter, stepDefinition);
	}
	 ...
	 * @api protected
	 */
	_beforeInitialize(scopeReporter, stepDefinition) {}
	 ...
	 * @api protected
	 */
	_afterInitialize(scopeReporter, stepDefinition) {}
	 ...
	 * @api protected
	 */
	_setupPredefinedEndpoints(scopeReporter, stepDefinition) {
	 ...
	 * @api protected
	 */
	_setupEndpointsFromConfig(scopeReporter, stepDefinition) {
