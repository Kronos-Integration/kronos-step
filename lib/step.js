...
class Step {
	...
	/**
	 * Starts the step.
	 * Mainly used by inbound adpater steps to start the http server or what ever
	...
	_start() {
		...
		return new Promise(function (fulfill, reject) {
			fulfill("Nothing to do");
		});
	}

	/**
	 * Stops the step.
	 * Mainly used by inbound adpater steps to stop the http server or what ever
	 * Must return a promise
	 */
	_stop() {
		// do nothing. Should be imlemented by the drived class
