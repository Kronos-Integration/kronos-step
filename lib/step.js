...
class Step {
	 ...
	 * @api protected
	 */
	_initializeInternal(manager, scopeReporter, name, stepConfiguration, stepDefinition) {
 ...
 */
Step.prototype.remove = states.transitionFunction(states.transitions.remove);
